defmodule Indexer.Transform.TokenTransfers do
  @moduledoc """
  Helper functions for transforming data for MIND-20 and ERC-721 token transfers.
  """
  ...
  @token_types_priority_order ["MIND-20", "ERC-721", "ERC-1155"]
  ...
  # MIND-20 token transfer for WETH
